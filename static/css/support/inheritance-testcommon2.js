...
function assert_initial(property, initial) {
  ...
  }, prefix + 'Property ' + property + ' has initial value ' + initial);
}
...
function assert_inherited(property, initial, other) {
  ...
  test(() => {
    ...
    target.style[property] = '';
  }, prefix + 'Property ' + property + ' inherits');
}
...
function assert_not_inherited(property, initial, other) {
  ...
  test(() => {
    ...
    container.style[property] = '';
    target.style[property] = '';
  }, prefix + 'Property ' + property + ' does not inherit');
}

window.assert_inherited2 = assert_inherited;
window.assert_not_inherited2 = assert_not_inherited;
})();
